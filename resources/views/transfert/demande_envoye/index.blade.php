...
@section('title', 'Consultation Demandes des Transferts Envoyée Golden Pos')
...
<div class="pos-container">
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Consultation Demandes Envoyées</h1>
            <p class="page-subtitle">Suivez et gérez vos demandes de transferts de stock.</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('transfert.demande_envoye.create') }}" class="btn btn-primary">
    ...
    <div class="kpi-grid">
        <div class="kpi-card">
            ...
            <div class="kpi-info">
                ...
                <span class="kpi-value" id="kpi-total">{{ number_format($totalDemandes, 0, ',', ' ') }}</span>
            </div>
        </div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-info">
                ...
                <span class="kpi-value text-info" id="kpi-brouillon">{{ number_format($brouillons, 0, ',', ' ') }}</span>
            </div>
        </div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-info">
                <span class="kpi-label">Envoyées</span>
                <span class="kpi-value text-success" id="kpi-envoye">{{ number_format($envoyes, 0, ',', ' ') }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="content-card">
        ...
        <div class="toolbar">
            <div class="search-wrapper">
                ...
                <input type="text" id="globalSearch" name="search" class="search-input" placeholder="Recherche rapide (N°, description)..." value="{{ request('search') }}">
            </div>
        </div>
            ...
            <table class="data-table" id="dataTable">
                <thead>
                    ...
                    <tr class="filter-row">
                        ...
                        <th><input type="text" class="filter-col" data-col="f_matricule" placeholder="Filtrer..."></th>
                        <th><input type="text" class="filter-col" data-col="f_description" placeholder="Filtrer..."></th>
                    </tr>
                </thead>
                <tbody id="tableBody">
                    @include('transfert.demande_envoye.partials.table', ['demandes' => $demandes])
                </tbody>
            </table>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fetchFilteredData(url = '{{ route("transfert.demande_envoye.index") }}') {
            ...
            .then(data => {
                ...
                if (data.kpis) {
                    if(document.getElementById('kpi-total')) document.getElementById('kpi-total').textContent = data.kpis.totalDemandes;
