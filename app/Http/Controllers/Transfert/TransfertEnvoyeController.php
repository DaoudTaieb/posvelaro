...
class TransfertEnvoyeController extends Controller
{
    public function index(Request $request)
    {
        ...
        // On récupère tous les sites pour le filtre récepteur
        $sites = DB::table('sites')->get();
        $siteExpediteur = DB::table('sites')->where('siteid', $siteid)->first();
        $siteLibelle = $siteExpediteur ? $siteExpediteur->libelle : 'Velaro';

        return view('transfert.envoye.index', compact('bontransferts', 'etats', 'defaultDateDebut', 'defaultDateFin', 'sites', 'siteLibelle'));
    }
